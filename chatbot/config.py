...
(train.py) y el servidor de red (app.py) compartan exactamente los mismos
valores y no haya desincronizacion entre lo entrenado y lo servido.
"""
...
FALLBACK_RESPONSE = (
    ...
    "Por favor, comunicate con Secretaría al correo secretaria@escuelatecnica.edu.ar "
    "o acercate a Preceptoría de lunes a viernes de 8:00 a 12:00 hs."
)

# --- Hiperparametros de la red neuronal (MLP) ----------------------------
HIDDEN_UNITS = (128, 64)   # Neuronas de las dos capas densas ocultas
DROPOUT_RATE = 0.5         # Regularizacion para evitar sobreajuste
EPOCHS = 400
BATCH_SIZE = 8
LEARNING_RATE = 0.001
RANDOM_SEED = 42           # Reproducibilidad del entrenamiento
